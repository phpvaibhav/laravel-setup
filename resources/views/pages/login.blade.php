            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" id="login-form" action="{{url('post-login')}}" method="post">
                     {{ csrf_field() }}
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" id="customCheckremember_me">
                        <label class="custom-control-label" for="customCheckremember_me">Remember Me</label>
                      </div>
                    </div>
